...
helm.sh/chart: {{ include "messageservice.chart" . }}
{{ include "messageservice.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "messageservice.selectorLabels" -}}
app.kubernetes.io/name: {{ include "messageservice.name" . }}
